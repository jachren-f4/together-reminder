/**
 * Reset Database with Test Couple - Quizzes Complete State
 *
 ...
 * - You or Me: unlocked, ready to start (no one has played yet)
 *
 * This allows testing:
 * 1. You or Me from fresh start
...
async function createTestData(): Promise<void> {
  ...
  try {
    ...
    // 2. Create couple_unlocks - You or Me is unlocked, ready to play
    await client.query(
    ...
    console.log('   ✓ couple_unlocks (You or Me unlocked, ready to start)');
    ...
    // No You or Me completions - neither has started
    console.log('   ✓ quest_completions (classic + affirmation: both users)');
    ...
    // No You or Me match - ready to start fresh

    // 7. Create LP transaction records (one per user per source)
    const lpSources = [
...
async function main() {
  console.log('\n' + '='.repeat(60));
  console.log('   RESET WITH TEST COUPLE - QUIZZES COMPLETE');
  ...
  console.log('      - You or Me: 🆕 unlocked, ready to start');
  console.log('      - Linked: 🔒 locked (unlocks after You or Me)');
  console.log('      - Word Search: 🔒 locked (unlocks after Linked)');
  console.log('      - LP: 90');

  console.log('\n   Testing flow:');
  console.log('      1. Login as either user → tap You or Me → start fresh');
  console.log('      2. Complete You or Me with both users → Linked unlocks');
  console.log('      3. Complete Linked → Word Search unlocks');
